    ...
    <div class="relative mx-auto grid w-full max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:items-center lg:px-8">
        <div>
            ...
            <h1 class="mt-5 font-display text-4xl font-extrabold leading-tight sm:text-5xl">
                Signalez les problèmes de votre commune
            </h1>

            <p class="mt-5 max-w-xl text-base leading-7 text-slate-300 sm:text-lg">
                Nids-de-poule, éclairage, propreté ou nuisances : la mairie suit chaque signalement en temps réel.
            </p>
            ...
            <dl class="mt-8 grid grid-cols-3 gap-3">
                ...
                <div class="rounded-xl border border-white/15 bg-white/10 p-3">
                    <dt class="text-xs uppercase tracking-wider text-slate-300">Résolus</dt>
            ...
            <div class="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
                <div class="grid gap-4">
                    <div class="rounded-2xl bg-slate-900/70 p-4">
                        ...
                        <p class="mt-1 text-sm font-semibold">Éclairage public en panne, rue des Lilas</p>
                        <p class="mt-2 text-xs text-brand-200">Pris en charge en 2h</p>
                    </div>
                    <div class="rounded-2xl bg-slate-900/70 p-4">
                        <p class="text-sm text-slate-300">Signalement résolu</p>
                        <p class="mt-1 text-sm font-semibold">Nid-de-poule boulevard Victor Hugo</p>
                        <p class="mt-2 text-xs text-emerald-300">Intervention terminée</p>
                    </div>
                    <div class="rounded-2xl bg-slate-900/70 p-4">
                        <p class="text-sm text-slate-300">Signalement en cours</p>
                        <p class="mt-1 text-sm font-semibold">Dépôt sauvage place du Marché</p>
                        <p class="mt-2 text-xs text-amber-300">Équipe municipale notifiée</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="mx-auto w-full max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
    <div class="mb-8 text-center">
        <h2 class="font-display text-3xl font-extrabold text-slate-900">Comment ça marche ?</h2>
        <p class="mt-2 text-slate-600">Trois étapes simples pour agir dans votre quartier.</p>
    </div>
    ...
    <div class="grid gap-4 md:grid-cols-3">
        <article class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p class="mt-2 text-sm leading-6 text-slate-600">Décrivez le problème, l'adresse et ajoutez une photo si nécessaire.</p>
        </article>
        <article class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p class="mt-2 text-sm leading-6 text-slate-600">La mairie qualifie la demande et lance l'intervention adaptée.</p>
        </article>
        <article class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <span class="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-brand-100 text-brand-700 font-bold">3</span>
            <h3 class="mt-4 font-display text-xl font-bold text-slate-900">Résolution</h3>
            <p class="mt-2 text-sm leading-6 text-slate-600">Le statut est mis à jour et vous suivez l'avancement en ligne.</p>
        </article>
    </div>
</section>
...
<section class="bg-white py-14">
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mb-8 text-center">
            <h2 class="font-display text-3xl font-extrabold text-slate-900">Catégories fréquentes</h2>
            <p class="mt-2 text-slate-600">Choisissez la catégorie adaptée à votre incident.</p>
        </div>
...
<section class="mx-auto w-full max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
    <div class="mb-8 flex flex-wrap items-end justify-between gap-3">
        <div>
            ...
            <p class="mt-2 text-slate-600">Incidents signalés récemment par les citoyens.</p>
        </div>
    ...
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="overflow-hidden rounded-3xl bg-gradient-to-r from-brand-700 via-brand-600 to-cyan-600 p-8 text-white shadow-soft sm:p-10">
            <div class="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
                <div>
                    <h2 class="font-display text-3xl font-extrabold">Vous avez constaté un problème ?</h2>
                    <p class="mt-3 max-w-2xl text-sm leading-6 text-white/90 sm:text-base">
                        Lancez un signalement en moins de deux minutes et recevez un numéro de suivi.
                    </p>
                </div>
                <a href="{{ route('vitrine.signaler') }}"
